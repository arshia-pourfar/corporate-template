...
// import React, { useId, useEffect, useState } from "react"; // React hooks
// import Particles, { initParticlesEngine } from "@tsparticles/react"; // Particles library
// import type { Container } from "@tsparticles/engine"; // Type definitions for particles
...
//         id,
//         className,
//         background = "#0d47a1", // Default background color
//         minSize = 1, // Default minimum particle size
//         maxSize = 3, // Default maximum particle size
//         speed = 4, // Default animation speed
//         particleColor = "#ffffff", // Default particle color
//         particleDensity = 120, // Default particle density
//     } = props;
...
//                 setError("Failed to load particles. Please try again later."); // Set error state
//             });
//     }, []);
...
//             aria-label="Particle effect container" // ARIA label for accessibility
//         >
...
//                     options={particleOptions} // Particle configuration
//                 />
//             ) : error ? (
