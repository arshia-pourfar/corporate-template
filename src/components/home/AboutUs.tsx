...
export default function AboutUs() {
    return (
        <section className="flex flex-col-reverse lg:flex-row justify-between items-stretch">
            <div className="basis-1/2 text-center md:text-left px-4 relative">
                ...
                <Link href="/about" className="p-3 w-full lg:w-auto px-10 font-medium text-xl bg-accent text-bg-primary rounded-full xl:absolute mt-5 bottom-3">
                    Learn More
                </Link>
            </div>
